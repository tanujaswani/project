...
<?php 
   ...
   {
        $date=date("Y-m-d");
        mysqli_query($link,"insert into exam_result(id,username,exam_type,total_questions,correct_answer,wrong_answer,exam_time) values(NULL,'$_SESSION[username]','$_SESSION[exam_category]','$count','$correct','$wrong','$date')") or die(mysqli_error($link));
   }
   if(isset($_SESSION["exam_start"]))
   {
